...
class ProtvistaPdbLigandsSequence extends NightingaleSequence {
  #seq_bg;
  #axis;
  #bases;
  #resizeObserver;
...
//   _syncWidthWithParent() {
//     const parentEl = this.parentElement;
//     let widthPx = 0;

//     if (parentEl) {
//       widthPx = parentEl.getBoundingClientRect().width;
//     }
...
//   }
  ...
  getCharSize() {
    ...
    // Ligand labels are wider than single residue letters.
  ...
  renderD3() {
    ...
    const bases =
      space < 0
        ? []
        : this.sequenceData?.slice(first, last).map((atomName, i) => ({
            position: 1 + first + i,
            atomName,
          })) || [];
...
export default ProtvistaPdbLigandsSequence;